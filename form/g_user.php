                    ...
                    foreach($afilter as $filtro)
                    {
                        ...
                        if ($acol['type'] <> 'date') {
                            $cuser->labelinput($acol['name'],"",$acol['label'],$acol['type'],$acol['size'],$acol['brequeried'],$acol['bfind'],false);
                               ...
                               $cuser->labelinput('D_'.$acol['name'],"",'D. '.$acol['label'],$acol['type'],$acol['size'],$acol['brequeried'],false,false); 
                               $cuser->labelinput('H_'.$acol['name'],"",'H. '.$acol['label'],$acol['type'],$acol['size'],$acol['brequeried'],$acol['bfind'],false); 
                        }
                    }
        ...
        <tbody>
            <?php
                ...
                foreach($rows as $afila){
                    ...
                    {
                        $acol = get_object_vars($col);
                        $afila[$acol['name']] = $cuser->rowgrid($afila[$acol['name']], $acol['type']);
